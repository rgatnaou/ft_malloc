...
{
    void	*t	= malloc(1);
    void	*t0	= malloc(TINY_BLOCK_MAX);
    void	*t00	= malloc(TINY_BLOCK_MAX);
    void	*t000	= malloc(TINY_BLOCK_MAX);
    void	*t1	= malloc(SMALL_BLOCK_MAX);
    void	*t2	= malloc(SMALL_BLOCK_MAX + 1);
...
{
    void *t = malloc(SMALL_BLOCK_MAX + 1);
